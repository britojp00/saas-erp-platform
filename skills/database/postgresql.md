...
As chaves devem ser geradas pelo PostgreSQL.
...
O banco armazena internamente em UTC. A aplicação
apresenta os dados no timezone configurado (APP_TIMEZONE).

O instante temporal deve ser preservado em qualquer

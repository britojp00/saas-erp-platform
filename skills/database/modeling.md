...
No SQLAlchemy, utilizar BigInteger com Identity:
...
A escolha de BIGINT permite identificar entidades com
sequência numérica eficiente e compatível com o
desempenho do PostgreSQL.

IDs devem ser gerados pelo banco por meio do mecanismo
IDENTITY.
...
O banco armazena internamente em UTC. A apresentação dos
dados utiliza o timezone configurado na aplicação
(APP_TIMEZONE). O instante temporal deve ser preservado.
